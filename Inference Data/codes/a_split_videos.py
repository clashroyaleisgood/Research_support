...
def extract(video_path: str, large_folder_path: str, img_type: str='jpg') -> None:
    '''
    ...
    vidcap.release()
    print(f'End extracting {counter} frames\n')
...
def extract_one_video(inference_dataset_name, video_name):
    '''
    ...
    extract(video_path, output_large_folder)

def extract_videos(inference_dataset_name, video_names):
...
if __name__ == '__main__':
    ...
    extract_videos(inference_dataset_name, video_names)
